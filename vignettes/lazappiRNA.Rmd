...
be turned off as _HTSFilter_ is assumed to be applied at the normalisation
stage.
...
Before we examine the results we should first inspect the (unadjusted) pvalues.
...
```{r p-values}
pval.plots <- listPlotPvals(tested)
...
another excellent package _VennDiagram_, which provides a _grid_ graphics object.
